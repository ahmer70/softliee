...
const FindMobile = () => {
    ...
    return (
        <div className="my-2 ">
            <p className='border-start border-danger mb-2 ps-2' style={{ fontSize: "26px ", fontWeight: "bold" }}>Lets Find A Mobile Phone</p>
            <div className="mx-auto position-relative" style={{ width: "740px" }}>
                <MobileRange />
